  ...
  return (
    <div className="bg-[url('https://img.freepik.com/free-photo/brick-wall-painted-white_1194-7526.jpg?w=740&t=st=1708082336~exp=1708082936~hmac=b850584730a08c268a3896f5b4fb839fbdbd9126e11cc67712a04dcda7c2c741')]  h-screen  flex items-center justify-center">
	 ...
	 bg-white shadow-2xl rounded-md flex flex-col justify-around "
      ...
      focus:invalid:border-slate-300 focus:invalid:border-slate-300"
                  />
                  <span  onClick={passwordVisiblity} className="relative inline-block bottom-[20px] left-[280px] hover:text-black	 text-gray-600 focus:outline-none">
      ...
      focus:invalid:border-slate-300 focus:invalid:border-slate-300"
                  />
                  <span  onClick={confirmPasswordVisiblity} className=" text-gray-600 inline-block	 relative bottom-[20px] left-[280px] hover:text-gray-600 focus:outline-none hover:text-black">
	 ...
	 bg-white shadow-2xl rounded-md flex flex-col justify-center "
      ...
      focus:invalid:border-slate-300 focus:invalid:border-slate-300"
                  ...
                  <span  onClick={passwordVisiblity} className="relative inline-block bottom-[20px] left-[320px] hover:text-black	 text-gray-600 focus:outline-none">
                    {showPassword ? <FaRegEyeSlash />  : <FaRegEye /> }
                  </span>
